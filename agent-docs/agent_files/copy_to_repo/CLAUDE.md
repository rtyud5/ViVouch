# CLAUDE.md — Voucher E-Commerce Project Instructions
...
Think through business rules before editing. Prefer careful, minimal changes. Always explain transaction and RBAC-sensitive changes in comments or PR summary.
