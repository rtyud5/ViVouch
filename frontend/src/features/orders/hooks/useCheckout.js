...
export function useCheckout(options = {}) {
  ...
  return useMutation({
    mutationFn: ({ items, paymentMethod, recipientName, recipientPhone, note, idempotencyKey }) =>
      checkout(items, paymentMethod, recipientName, recipientPhone, note, idempotencyKey),
